...
var.list <- 
namedList(OBJECTID,URL,RETURN_VERSION,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SC_03_DUES_NONDEDUCT_X,SC_03_INHOUSE_LOB_EXP_LT_2K_X,SC_03_AGREE_CARRYOVER_LOB_PY_X,SC_03_AMT_DUE_ASSESS,SC_03_NONDEDUCT_LOB_CY,SC_03_NONDEDUCT_LOB_CARRYOVER,SC_03_NONDEDUCT_LOB_TOT,SC_03_AMT_AGGREGATE_REPORTED,SC_03_AMT_CARRYOVER_NY,SC_03_AMT_TAXABLE_LOB)
