...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_CUSTOMER_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_RESP_PARTY_INFO_CURR_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_AUTENTICATED_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_IDENTITY_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_DEVICE_ID, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_IP_ADDR, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_FILING_LIC_TYPE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_IP_DATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_IP_TIME, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_IP_TIME_ZONE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_FED_ASSURANCE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_OOB_VERIFIED_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_RQR_OOB_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_SEC_SUBMISSION_ID, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_REASONABLE_CAUSE_TXT, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_PHONE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_PW_CHANGE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_GRO_RCPT_LT50K_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_NAME_CHANGE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_IN_CARE_OF, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_APPLICATION_PEND_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_DISASTER_RELIEF, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_PROFILE_CHANGE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_02_PREP_PERS_SSN, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_IRS_TRUST_USRNAME_CHANGE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_FORM_ADDR_CHANGE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_L1, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_L2, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_CITY, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_CNTR, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_ZIP, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_ADDR_STATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ALL_AFFIL_INCL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_AMENDED_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_LEGAL_DMCL_CNTR, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_NAME_DBA_L1, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_NAME_DBA_L2, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_FINAL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_GRO_RCPT, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_GROUP_EXEMPT_NUM, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_GROUP_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_INITIAL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_NAME_ORG_L1, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_NAME_PERS, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_EXEMPT_STAT_4947A1_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_EXEMPT_STAT_501C_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_EXEMPT_STAT_527_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_LEGAL_DMCL_STATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TYPE_ORG_ASSOC_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TYPE_ORG_CORP_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TYPE_ORG_OTH_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TYPE_ORG_TRUST_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TYPE_ORG_OTH_DESC, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_WEBSITE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_YEAR_FORMATION, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_PRIN_OFF_NAME_ORG_L2, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_EXEMPT_STAT_501C3_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_SPECIAL_COND_DESC, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_L1, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_CITY, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_STATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_ZIP, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_BUILD_TIME_STAMP, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_NAME_L1, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_NAME_L2, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_NAME_ORG_CTRL, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_EIN, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_L2, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_ORG_ADDR_CNTR, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_TIME_STAMP, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_RETURN_TYPE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TAX_PERIOD_BEGIN_DATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TAX_PERIOD_END_DATE, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_00_TAX_YEAR, ein=ORG_EIN, year=TAX_YEAR, url=URL )
