...
var.list <- 
namedList(OBJECTID,URL,RETURN_VERSION,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,F9_03_ORG_MISSION_PURPOSE,F9_03_PROG_NEW_X,F9_03_PROG_CHANGE_X)
