...
SG_02_FUNDR_EVNT_EXP_FOOD_TOT <- xml2::xml_text( xml2::xml_find_all( doc, V_FUNDR_EVNT_EXP_FOOD_TOT ) )
...
SG_02_FUNDR_EVNT_EXP_ENTMT_TOT <- xml2::xml_text( xml2::xml_find_all( doc, V_FUNDR_EVNT_EXP_ENTMT_TOT ) )
