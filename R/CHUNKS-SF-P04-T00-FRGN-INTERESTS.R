...
var.list <- 
namedList(OBJECTID,URL,RETURN_VERSION,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SF_04_FRGN_CORP_TRANSFEROR_X,SF_04_FRGN_TRUST_INT_X,SF_04_FRGN_CORP_OWNERSHIP_INT_X,SF_04_FRGN_FUND_SHAREHOLDER_X,SF_04_FRGN_PTR_OWNERSHIP_INT_X,SF_04_BOYCOTTING_CNTR_ACT_X)
