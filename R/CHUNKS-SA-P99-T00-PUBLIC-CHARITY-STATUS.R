...
var.list <- 
namedList(OBJECTID,URL,RETURN_VERSION,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SA_99_PCSTAT_SUPPORT_T3_OTH_X,SA_99_PCSTAT_CERTIFICATION_X,SA_99_PCSTAT_CONTR_PERS_X,SA_99_PCSTAT_CONTR_FAM_PARTY_X,SA_99_PCSTAT_CONTR_35PCT_CE_X)
