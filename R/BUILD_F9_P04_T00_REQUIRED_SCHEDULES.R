...
{ 
  log_collapsed_record( varname=F9_04_PTR_ACT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_HOSPITAL_AFS_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_BALANCE_SHEET_AMT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_BIZ_TRANSAC_DTK_FAM_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_BIZ_TRANSAC_DTK_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_BIZ_TRANSAC_DTK_ENTITY_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_COLLEC_ART_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_CONSERV_EMT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_AFS_CONSOL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_CREDIT_COUNS_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_CONTR_ART_HIST_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_CONTR_NONCSH_MT_25K_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_DESC_IN_501C3_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_ENTITY_DISREG_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-06
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/DonorAdvisedFundInd'
V2 <- '//Return/ReturnData/IRS990/DonorAdvisedFunds'
V3 <- '//Return/ReturnData/IRS990/Form990PartIV/DonorAdvisedFunds'
V4 <- '//Return/ReturnData/IRS990EZ/DonorAdvisedFndsInd'
V5 <- '//Return/ReturnData/IRS990EZ/MaintainAnyDonorAdvisedFunds'
V_DAF_X <- paste( V1, V2, V3, V4, V5 , sep='|' )
F9_04_DAF_X <- xml2::xml_text( xml2::xml_find_all( doc, V_DAF_X ) )
if( length( F9_04_DAF_X ) > 1 )
{ 
  log_collapsed_record( varname=F9_04_DAF_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-25A
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/EngagedInExcessBenefitTrans'
V2 <- '//Return/ReturnData/IRS990/EngagedInExcessBenefitTransInd'
V3 <- '//Return/ReturnData/IRS990/ExcessBenefitTransaction'
V4 <- '//Return/ReturnData/IRS990/Form990PartIV/ExcessBenefitTransaction'
V5 <- '//Return/ReturnData/IRS990EZ/EngagedInExcessBenefitTrans'
V6 <- '//Return/ReturnData/IRS990EZ/EngagedInExcessBenefitTransInd'
...
{ 
  log_collapsed_record( varname=F9_04_TRANSAC_ENGAGED_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_TAX_EXEMPT_BOND_ESCROW_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_FRGN_ACT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-14A
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/ForeignOffice'
V2 <- '//Return/ReturnData/IRS990/ForeignOfficeInd'
V3 <- '//Return/ReturnData/IRS990/Form990PartIV/ForeignOffice'
V4 <- '//Return/ReturnData/IRS990EZ/ForeignOffice'
V5 <- '//Return/ReturnData/IRS990EZ/ForeignOfficeInd'
...
{ 
  log_collapsed_record( varname=F9_04_FRGN_OFFICE_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_FUNDR_ACT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## DESCRIPTION:  Form990 Part IV - Gaming?
## LOCATION:  F990-PC-PART-04-LINE-19
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/Gaming'
V2 <- '//Return/ReturnData/IRS990/Gaming'
V3 <- '//Return/ReturnData/IRS990/GamingActivitiesInd'
V4 <- '//Return/ReturnData/IRS990/IsAnyRevenueFromGaming'
V5 <- '//Return/ReturnData/IRS990EZ/IsAnyRevenueFromGaming'
...
{ 
  log_collapsed_record( varname=F9_04_GAMING_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
V1 <- '//Return/ReturnData/IRS990/Form990PartIV/GrantsToIndividuals'
V2 <- '//Return/ReturnData/IRS990/GrantsToIndividuals'
V3 <- '//Return/ReturnData/IRS990/GrantsToIndividualsInd'
...
{ 
  log_collapsed_record( varname=F9_04_GRANT_MT_5K_US_INDIV_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_GRANT_MT_5K_US_ORG_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_GRANT_RLTD_PERS_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## DESCRIPTION:  Form990 Part IV - Hospital?
## LOCATION:  F990-PC-PART-04-LINE-20A
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/Hospital'
V2 <- '//Return/ReturnData/IRS990/Hospital'
V3 <- '//Return/ReturnData/IRS990/OperateHospitalInd'
V4 <- '//Return/ReturnData/IRS990EZ/DoesOrgHaveHospital'
V5 <- '//Return/ReturnData/IRS990EZ/OperateHospitalInd'
...
{ 
  log_collapsed_record( varname=F9_04_HOSPITAL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_TAX_EXEMPT_BOND_INVEST_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-26
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/LoanToOfficerOrDQP'
V2 <- '//Return/ReturnData/IRS990/LoanOutstandingInd'
V3 <- '//Return/ReturnData/IRS990/LoanToOfficerOrDQP'
V4 <- '//Return/ReturnData/IRS990EZ/MadeLoansToFromOfficers'
V5 <- '//Return/ReturnData/IRS990EZ/MadeLoansToFromOfficersInd'
...
{ 
  log_collapsed_record( varname=F9_04_LOAN_DTK_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-04
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/LobbyingActivities'
V2 <- '//Return/ReturnData/IRS990/LobbyingActivities'
V3 <- '//Return/ReturnData/IRS990/LobbyingActivitiesInd'
V4 <- '//Return/ReturnData/IRS990EZ/EngageInLobbyingActivities'
V5 <- '//Return/ReturnData/IRS990EZ/LobbyingActivitiesInd'
...
{ 
  log_collapsed_record( varname=F9_04_LOB_ACT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_GRANT_MT_5K_FRGN_INDIV_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_GRANT_MT_5K_FRGN_ORG_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_TAX_EXEMPT_BOND_ISSUER_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_DOA_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_COMP_DTK_YES_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-03
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/PoliticalActivities'
V2 <- '//Return/ReturnData/IRS990/PoliticalActivities'
V3 <- '//Return/ReturnData/IRS990/PoliticalCampaignActyInd'
V4 <- '//Return/ReturnData/IRS990EZ/EngagePoliticalCmpgnActivities'
V5 <- '//Return/ReturnData/IRS990EZ/PoliticalCampaignActyInd'
...
{ 
  log_collapsed_record( varname=F9_04_POLI_ACT_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_TRANSAC_PY_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_PROF_FUNDR_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_ENTITY_RLTD_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-35A
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/RelatedOrgControlledEntity'
V2 <- '//Return/ReturnData/IRS990/RelatedOrganizationCtrlEntInd'
V3 <- '//Return/ReturnData/IRS990/RelatedOrgControlledEntity'
V4 <- '//Return/ReturnData/IRS990EZ/RelatedOrganizationCtrlEntInd'
V5 <- '//Return/ReturnData/IRS990EZ/RelatedOrgControlledEntity'
...
{ 
  log_collapsed_record( varname=F9_04_ENTITY_CTRL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
V1 <- '//Return/ReturnData/IRS990/Form990PartIV/ScheduleBRequired'
V2 <- '//Return/ReturnData/IRS990/ScheduleBNotRequired'
V3 <- '//Return/ReturnData/IRS990/ScheduleBRequired'
V4 <- '//Return/ReturnData/IRS990/ScheduleBRequiredInd'
V5 <- '//Return/ReturnData/IRS990EZ/ScheduleBNotRequired'
V6 <- '//Return/ReturnData/IRS990EZ/ScheduleBNotRequiredInd'
...
{ 
  log_collapsed_record( varname=F9_04_SCHED_B_REQ_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## DESCRIPTION:  Form990 Part IV - School?
## LOCATION:  F990-PC-PART-04-LINE-13
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/School'
V2 <- '//Return/ReturnData/IRS990/School'
V3 <- '//Return/ReturnData/IRS990/SchoolOperatingInd'
V4 <- '//Return/ReturnData/IRS990EZ/OperatingSchool'
V5 <- '//Return/ReturnData/IRS990EZ/SchoolOperatingInd'
...
{ 
  log_collapsed_record( varname=F9_04_SCHOOL_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-05
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/SubjectToProxyTax'
V2 <- '//Return/ReturnData/IRS990/SubjectToProxyTax'
V3 <- '//Return/ReturnData/IRS990/SubjectToProxyTaxInd'
V4 <- '//Return/ReturnData/IRS990EZ/SubjectToProxyTax'
V5 <- '//Return/ReturnData/IRS990EZ/SubjectToProxyTaxInd'
...
{ 
  log_collapsed_record( varname=F9_04_PROXY_TAX_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_TAX_EXEMPT_BOND_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_LTD_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_ENDOW_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-36
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/Form990PartIV/TransfersToExemptNonChrtblOrg'
V2 <- '//Return/ReturnData/IRS990/TransfersToExemptNonChrtblOrg'
V3 <- '//Return/ReturnData/IRS990/TrnsfrExmptNonChrtblRltdOrgInd'
V4 <- '//Return/ReturnData/IRS990EZ/TrnsfrExmptNonChrtblRltdOrgInd'
V5 <- '//Return/ReturnData/IRS990EZ/TrnsfrsExemptNonCharRelatedOrg'
...
{ 
  log_collapsed_record( varname=F9_04_TRANSFER_EXEMPT_ORG_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_FOOTNOTE_FIN48_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_AFS_IND_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_INVEST_OTH_SEC_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_LAND_BLDG_EQUIP_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_OTH_ASSET_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_OTH_LIAB_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_REP_PROG_RLTD_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_SCHED_O_REQ_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
## LOCATION:  F990-PC-PART-04-LINE-35B
## TABLE:  F9-P04-T00-REQUIRED-SCHEDULES
## VARIABLE TYPE:  checkbox
## PRODUCTION RULE:  NA

V1 <- '//Return/ReturnData/IRS990/TransactionRelatedEntity'
V2 <- '//Return/ReturnData/IRS990/TransactionWithControlEntInd'
V3 <- '//Return/ReturnData/IRS990EZ/TransactionRelatedEntity'
V4 <- '//Return/ReturnData/IRS990EZ/TransactionWithControlEntInd'
V5 <- '//Return/ReturnData/IRS990EZ/TransactionWithControlEntity'
...
{ 
  log_collapsed_record( varname=F9_04_ENTITY_CTRL_TRANSAC_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
{ 
  log_collapsed_record( varname=F9_04_LTD_DOA_X, ein=ORG_EIN, year=TAX_YEAR, url=URL )
...
var.list <- 
namedList(F9_04_PTR_ACT_X,F9_04_HOSPITAL_AFS_X,F9_04_REP_BALANCE_SHEET_AMT_X,F9_04_BIZ_TRANSAC_DTK_FAM_X,F9_04_BIZ_TRANSAC_DTK_X,F9_04_BIZ_TRANSAC_DTK_ENTITY_X,F9_04_COLLEC_ART_X,F9_04_CONSERV_EMT_X,F9_04_AFS_CONSOL_X,F9_04_CREDIT_COUNS_X,F9_04_CONTR_ART_HIST_X,F9_04_CONTR_NONCSH_MT_25K_X,F9_04_DESC_IN_501C3_X,F9_04_ENTITY_DISREG_X,F9_04_DAF_X,F9_04_TRANSAC_ENGAGED_X,F9_04_TAX_EXEMPT_BOND_ESCROW_X,F9_04_FRGN_ACT_X,F9_04_FRGN_OFFICE_X,F9_04_FUNDR_ACT_X,F9_04_GAMING_X,F9_04_GRANT_MT_5K_US_INDIV_X,F9_04_GRANT_MT_5K_US_ORG_X,F9_04_GRANT_RLTD_PERS_X,F9_04_HOSPITAL_X,F9_04_TAX_EXEMPT_BOND_INVEST_X,F9_04_LOAN_DTK_X,F9_04_LOB_ACT_X,F9_04_GRANT_MT_5K_FRGN_INDIV_X,F9_04_GRANT_MT_5K_FRGN_ORG_X,F9_04_TAX_EXEMPT_BOND_ISSUER_X,F9_04_DOA_X,F9_04_COMP_DTK_YES_X,F9_04_POLI_ACT_X,F9_04_TRANSAC_PY_X,F9_04_PROF_FUNDR_X,F9_04_ENTITY_RLTD_X,F9_04_ENTITY_CTRL_X,F9_04_SCHED_B_REQ_X,F9_04_SCHOOL_X,F9_04_PROXY_TAX_X,F9_04_TAX_EXEMPT_BOND_X,F9_04_LTD_X,F9_04_ENDOW_X,F9_04_TRANSFER_EXEMPT_ORG_X,F9_04_REP_FOOTNOTE_FIN48_X,F9_04_AFS_IND_X,F9_04_REP_INVEST_OTH_SEC_X,F9_04_REP_LAND_BLDG_EQUIP_X,F9_04_REP_OTH_ASSET_X,F9_04_REP_OTH_LIAB_X,F9_04_REP_PROG_RLTD_X,F9_04_SCHED_O_REQ_X,F9_04_ENTITY_CTRL_TRANSAC_X,F9_04_LTD_DOA_X)
