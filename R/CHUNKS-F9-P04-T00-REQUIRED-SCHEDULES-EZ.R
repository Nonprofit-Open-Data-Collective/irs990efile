...
var.list <- 
namedList(OBJECTID,URL,RETURN_VERSION,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,F9_04_LOAN_DTK_AMT,F9_04_FRGN_OFFICE_CNTR,F9_04_RLTD_ORG_527_X)
