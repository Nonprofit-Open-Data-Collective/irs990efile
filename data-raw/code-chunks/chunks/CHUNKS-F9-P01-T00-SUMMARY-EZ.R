...
F9_01_INFO_SCHED_O_X <- xml_text( xml_find_all( doc, V_INFO_SCHED_O_X ) )
...
F9_01_EXP_FEE_OTH_PAY_KONTR <- xml_text( xml_find_all( doc, V_EXP_FEE_OTH_PAY_KONTR ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,F9_01_INFO_SCHED_O_X,F9_01_EXP_FEE_OTH_PAY_KONTR)
