...
SH_03_BAD_DEBT_EXP_REPORTED_X <- xml_text( xml_find_all( doc, V_BAD_DEBT_EXP_REPORTED_X ) )
...
SH_03_BAD_DEBT_EXP_AMT <- xml_text( xml_find_all( doc, V_BAD_DEBT_EXP_AMT ) )
...
SH_03_BAD_DEBT_CONTR_FAP <- xml_text( xml_find_all( doc, V_BAD_DEBT_CONTR_FAP ) )
...
SH_03_MEDICARE_REIMBURSE_AMT <- xml_text( xml_find_all( doc, V_MEDICARE_REIMBURSE_AMT ) )
...
SH_03_MEDICARE_COST_REIMBURSED  <- xml_text( xml_find_all( doc, V_MEDICARE_COST_REIMBURSED  ) )
...
SH_03_MEDICARE_SURPLUS <- xml_text( xml_find_all( doc, V_MEDICARE_SURPLUS ) )
...
SH_03_MEDICARE_COST_ACC_X <- xml_text( xml_find_all( doc, V_MEDICARE_COST_ACC_X ) )
...
SH_03_MEDICARE_COST_OTH_X <- xml_text( xml_find_all( doc, V_MEDICARE_COST_OTH_X ) )
...
SH_03_MEDICARE_COST_RATIO_X <- xml_text( xml_find_all( doc, V_MEDICARE_COST_RATIO_X ) )
...
SH_03_COLLEC_POLICY_WRITTEN_X <- xml_text( xml_find_all( doc, V_COLLEC_POLICY_WRITTEN_X ) )
...
SH_03_COLLEC_POLICY_PROV_FA_X <- xml_text( xml_find_all( doc, V_COLLEC_POLICY_PROV_FA_X ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SH_03_BAD_DEBT_EXP_REPORTED_X,SH_03_BAD_DEBT_EXP_AMT,SH_03_BAD_DEBT_CONTR_FAP,SH_03_MEDICARE_REIMBURSE_AMT,SH_03_MEDICARE_COST_REIMBURSED ,SH_03_MEDICARE_SURPLUS,SH_03_MEDICARE_COST_ACC_X,SH_03_MEDICARE_COST_OTH_X,SH_03_MEDICARE_COST_RATIO_X,SH_03_COLLEC_POLICY_WRITTEN_X,SH_03_COLLEC_POLICY_PROV_FA_X)
