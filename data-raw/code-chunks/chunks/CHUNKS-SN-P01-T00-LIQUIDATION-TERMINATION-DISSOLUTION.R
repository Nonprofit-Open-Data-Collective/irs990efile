...
SN_01_ORG_DTK_DIR_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_DIR_SUCCESSOR_X ) )
...
SN_01_ORG_DTK_EMPL_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_EMPL_SUCCESSOR_X ) )
...
SN_01_ORG_DTK_OWN_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_OWN_SUCCESSOR_X ) )
...
SN_01_ORG_DTK_REC_COMP_X <- xml_text( xml_find_all( doc, V_ORG_DTK_REC_COMP_X ) )
...
SN_01_ORG_ASSET_DIST_GVRN_X <- xml_text( xml_find_all( doc, V_ORG_ASSET_DIST_GVRN_X ) )
...
SN_01_ORG_REQ_NOTIFY_ATTORNEY_X <- xml_text( xml_find_all( doc, V_ORG_REQ_NOTIFY_ATTORNEY_X ) )
...
SN_01_ORG_ATTORNEY_NOTIFIED_X <- xml_text( xml_find_all( doc, V_ORG_ATTORNEY_NOTIFIED_X ) )
...
SN_01_ORG_LIAB_PAID_X <- xml_text( xml_find_all( doc, V_ORG_LIAB_PAID_X ) )
...
SN_01_ORG_BOND_OUTSTANDING_X <- xml_text( xml_find_all( doc, V_ORG_BOND_OUTSTANDING_X ) )
