...
SD_11_RECO_REV_TOT_PER_AFS <- xml_text( xml_find_all( doc, V_RECO_REV_TOT_PER_AFS ) )
...
SD_11_RECO_REV_NUGAINS_INVEST <- xml_text( xml_find_all( doc, V_RECO_REV_NUGAINS_INVEST ) )
...
SD_11_RECO_REV_DONATED_SVC <- xml_text( xml_find_all( doc, V_RECO_REV_DONATED_SVC ) )
...
SD_11_RECO_REV_GRANT_PY <- xml_text( xml_find_all( doc, V_RECO_REV_GRANT_PY ) )
...
SD_11_RECO_REV_OTH <- xml_text( xml_find_all( doc, V_RECO_REV_OTH ) )
...
SD_11_RECO_REV_ADD_L2ABCD <- xml_text( xml_find_all( doc, V_RECO_REV_ADD_L2ABCD ) )
...
SD_11_RECO_REV_SUBTRACT_L2E_L1 <- xml_text( xml_find_all( doc, V_RECO_REV_SUBTRACT_L2E_L1 ) )
...
SD_11_RECO_REV_INVEST_NO_INCL <- xml_text( xml_find_all( doc, V_RECO_REV_INVEST_NO_INCL ) )
...
SD_11_RECO_REV_OTH_NO_INCL <- xml_text( xml_find_all( doc, V_RECO_REV_OTH_NO_INCL ) )
...
SD_11_RECO_REV_ADD_L4AB <- xml_text( xml_find_all( doc, V_RECO_REV_ADD_L4AB ) )
...
SD_11_RECO_REV_TOT    <- xml_text( xml_find_all( doc, V_RECO_REV_TOT    ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SD_11_RECO_REV_TOT_PER_AFS,SD_11_RECO_REV_NUGAINS_INVEST,SD_11_RECO_REV_DONATED_SVC,SD_11_RECO_REV_GRANT_PY,SD_11_RECO_REV_OTH,SD_11_RECO_REV_ADD_L2ABCD,SD_11_RECO_REV_SUBTRACT_L2E_L1,SD_11_RECO_REV_INVEST_NO_INCL,SD_11_RECO_REV_OTH_NO_INCL,SD_11_RECO_REV_ADD_L4AB,SD_11_RECO_REV_TOT   )
