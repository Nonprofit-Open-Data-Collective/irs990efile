...
SJ_01_COMP_PROV_CLUB_DUE_FEE_X <- xml_text( xml_find_all( doc, V_COMP_PROV_CLUB_DUE_FEE_X ) )
...
SJ_01_COMP_PROV_DISCRETIONARY_X <- xml_text( xml_find_all( doc, V_COMP_PROV_DISCRETIONARY_X ) )
...
SJ_01_COMP_PROV_FIRST_CLASS_X <- xml_text( xml_find_all( doc, V_COMP_PROV_FIRST_CLASS_X ) )
...
SJ_01_COMP_PROV_HOUSING_ALLOW_X <- xml_text( xml_find_all( doc, V_COMP_PROV_HOUSING_ALLOW_X ) )
...
SJ_01_COMP_PROV_INDEMNIFY_X <- xml_text( xml_find_all( doc, V_COMP_PROV_INDEMNIFY_X ) )
...
SJ_01_COMP_PROV_PERSONAL_SVC_X <- xml_text( xml_find_all( doc, V_COMP_PROV_PERSONAL_SVC_X ) )
...
SJ_01_COMP_PROV_TRAVEL_X <- xml_text( xml_find_all( doc, V_COMP_PROV_TRAVEL_X ) )
...
SJ_01_COMP_PROV_USE_RESIDENCE_X <- xml_text( xml_find_all( doc, V_COMP_PROV_USE_RESIDENCE_X ) )
...
SJ_01_COMP_WRITTEN_POLICY_X <- xml_text( xml_find_all( doc, V_COMP_WRITTEN_POLICY_X ) )
...
SJ_01_COMP_SUBSTANTIATION_REQ_X <- xml_text( xml_find_all( doc, V_COMP_SUBSTANTIATION_REQ_X ) )
...
SJ_01_COMP_METHOD_BOARD_APPROV_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_BOARD_APPROV_X ) )
...
SJ_01_COMP_METHOD_COMMITTEE_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_COMMITTEE_X ) )
...
SJ_01_COMP_METHOD_CONSULTANT_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_CONSULTANT_X ) )
...
SJ_01_COMP_METHOD_EMPL_KONTR_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_EMPL_KONTR_X ) )
...
SJ_01_COMP_METHOD_OTH_ORG_990_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_OTH_ORG_990_X ) )
...
SJ_01_COMP_METHOD_SURVEY_X <- xml_text( xml_find_all( doc, V_COMP_METHOD_SURVEY_X ) )
...
SJ_01_COMP_PAY_SEVERANCE_X <- xml_text( xml_find_all( doc, V_COMP_PAY_SEVERANCE_X ) )
...
SJ_01_COMP_PAY_RETIREMENT_PLAN_X <- xml_text( xml_find_all( doc, V_COMP_PAY_RETIREMENT_PLAN_X ) )
...
SJ_01_COMP_PAY_EQUITY_BASED_X <- xml_text( xml_find_all( doc, V_COMP_PAY_EQUITY_BASED_X ) )
...
SJ_01_COMP_CONTINGENT_REV_ORG_X <- xml_text( xml_find_all( doc, V_COMP_CONTINGENT_REV_ORG_X ) )
...
SJ_01_COMP_CONTINGENT_REV_RLTD_X <- xml_text( xml_find_all( doc, V_COMP_CONTINGENT_REV_RLTD_X ) )
...
SJ_01_COMP_CONTINGENT_NET_ORG_X <- xml_text( xml_find_all( doc, V_COMP_CONTINGENT_NET_ORG_X ) )
...
SJ_01_COMP_CONTINGENT_NET_RLTD_X <- xml_text( xml_find_all( doc, V_COMP_CONTINGENT_NET_RLTD_X ) )
...
SJ_01_COMP_NON_FIXED_PAYMENT_X <- xml_text( xml_find_all( doc, V_COMP_NON_FIXED_PAYMENT_X ) )
...
SJ_01_COMP_KONTR_EXCEPTION_X <- xml_text( xml_find_all( doc, V_COMP_KONTR_EXCEPTION_X ) )
...
SJ_01_COMP_REBUTTABLE_PROC_X <- xml_text( xml_find_all( doc, V_COMP_REBUTTABLE_PROC_X ) )
