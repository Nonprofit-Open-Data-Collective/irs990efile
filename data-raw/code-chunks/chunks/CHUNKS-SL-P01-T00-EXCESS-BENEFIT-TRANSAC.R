...
SL_01_TRANSAC_AMT_TAX_IMPOSED <- xml_text( xml_find_all( doc, V_TRANSAC_AMT_TAX_IMPOSED ) )
...
SL_01_TRANSAC_AMT_TAX_REIMBURSED <- xml_text( xml_find_all( doc, V_TRANSAC_AMT_TAX_REIMBURSED ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SL_01_TRANSAC_AMT_TAX_IMPOSED,SL_01_TRANSAC_AMT_TAX_REIMBURSED)
