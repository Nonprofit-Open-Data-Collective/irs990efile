...
F9_04_DESC_IN_501C3_X <- xml_text( xml_find_all( doc, V_DESC_IN_501C3_X ) )
...
F9_04_SCHED_B_REQ_X <- xml_text( xml_find_all( doc, V_SCHED_B_REQ_X ) )
...
F9_04_POLI_ACT_X <- xml_text( xml_find_all( doc, V_POLI_ACT_X ) )
...
F9_04_LOB_ACT_X <- xml_text( xml_find_all( doc, V_LOB_ACT_X ) )
...
F9_04_PROXY_TAX_X <- xml_text( xml_find_all( doc, V_PROXY_TAX_X ) )
...
F9_04_DAF_X <- xml_text( xml_find_all( doc, V_DAF_X ) )
...
F9_04_CONSERV_EMT_X <- xml_text( xml_find_all( doc, V_CONSERV_EMT_X ) )
...
F9_04_COLLEC_ART_X <- xml_text( xml_find_all( doc, V_COLLEC_ART_X ) )
...
F9_04_CREDIT_COUNS_X <- xml_text( xml_find_all( doc, V_CREDIT_COUNS_X ) )
...
F9_04_ENDOW_X <- xml_text( xml_find_all( doc, V_ENDOW_X ) )
...
F9_04_REP_BALANCE_SHEET_AMT_X <- xml_text( xml_find_all( doc, V_REP_BALANCE_SHEET_AMT_X ) )
...
F9_04_REP_LAND_BLDG_EQUIP_X <- xml_text( xml_find_all( doc, V_REP_LAND_BLDG_EQUIP_X ) )
...
F9_04_REP_INVEST_OTH_SEC_X <- xml_text( xml_find_all( doc, V_REP_INVEST_OTH_SEC_X ) )
...
F9_04_REP_PROG_RLTD_X <- xml_text( xml_find_all( doc, V_REP_PROG_RLTD_X ) )
...
F9_04_REP_OTH_ASSET_X <- xml_text( xml_find_all( doc, V_REP_OTH_ASSET_X ) )
...
F9_04_REP_OTH_LIAB_X <- xml_text( xml_find_all( doc, V_REP_OTH_LIAB_X ) )
...
F9_04_REP_FOOTNOTE_FIN48_X <- xml_text( xml_find_all( doc, V_REP_FOOTNOTE_FIN48_X ) )
...
F9_04_AFS_IND_X <- xml_text( xml_find_all( doc, V_AFS_IND_X ) )
...
F9_04_AFS_CONSOL_X <- xml_text( xml_find_all( doc, V_AFS_CONSOL_X ) )
...
F9_04_SCHOOL_X <- xml_text( xml_find_all( doc, V_SCHOOL_X ) )
...
F9_04_FRGN_OFFICE_X <- xml_text( xml_find_all( doc, V_FRGN_OFFICE_X ) )
...
F9_04_FRGN_ACT_X <- xml_text( xml_find_all( doc, V_FRGN_ACT_X ) )
...
F9_04_GRANT_MT_5K_FRGN_ORG_X <- xml_text( xml_find_all( doc, V_GRANT_MT_5K_FRGN_ORG_X ) )
...
F9_04_GRANT_MT_5K_FRGN_INDIV_X <- xml_text( xml_find_all( doc, V_GRANT_MT_5K_FRGN_INDIV_X ) )
...
F9_04_PROF_FUNDR_X <- xml_text( xml_find_all( doc, V_PROF_FUNDR_X ) )
...
F9_04_FUNDR_ACT_X <- xml_text( xml_find_all( doc, V_FUNDR_ACT_X ) )
...
F9_04_GAMING_X <- xml_text( xml_find_all( doc, V_GAMING_X ) )
...
F9_04_HOSPITAL_X <- xml_text( xml_find_all( doc, V_HOSPITAL_X ) )
...
F9_04_HOSPITAL_AFS_X <- xml_text( xml_find_all( doc, V_HOSPITAL_AFS_X ) )
...
F9_04_GRANT_MT_5K_US_ORG_X <- xml_text( xml_find_all( doc, V_GRANT_MT_5K_US_ORG_X ) )
...
F9_04_GRANT_MT_5K_US_INDIV_X <- xml_text( xml_find_all( doc, V_GRANT_MT_5K_US_INDIV_X ) )
...
F9_04_COMP_DTK_YES_X <- xml_text( xml_find_all( doc, V_COMP_DTK_YES_X ) )
...
F9_04_TAX_EXEMPT_BOND_X <- xml_text( xml_find_all( doc, V_TAX_EXEMPT_BOND_X ) )
...
F9_04_TAX_EXEMPT_BOND_INVEST_X <- xml_text( xml_find_all( doc, V_TAX_EXEMPT_BOND_INVEST_X ) )
...
F9_04_TAX_EXEMPT_BOND_ISSUER_X <- xml_text( xml_find_all( doc, V_TAX_EXEMPT_BOND_ISSUER_X ) )
...
F9_04_TAX_EXEMPT_BOND_ESCROW_X <- xml_text( xml_find_all( doc, V_TAX_EXEMPT_BOND_ESCROW_X ) )
...
F9_04_TRANSAC_ENGAGED_X <- xml_text( xml_find_all( doc, V_TRANSAC_ENGAGED_X ) )
...
F9_04_TRANSAC_PY_X <- xml_text( xml_find_all( doc, V_TRANSAC_PY_X ) )
...
F9_04_LOAN_DTK_X <- xml_text( xml_find_all( doc, V_LOAN_DTK_X ) )
...
F9_04_GRANT_RLTD_PERS_X <- xml_text( xml_find_all( doc, V_GRANT_RLTD_PERS_X ) )
...
F9_04_BIZ_TRANSAC_DTK_X <- xml_text( xml_find_all( doc, V_BIZ_TRANSAC_DTK_X ) )
...
F9_04_BIZ_TRANSAC_DTK_FAM_X <- xml_text( xml_find_all( doc, V_BIZ_TRANSAC_DTK_FAM_X ) )
...
F9_04_BIZ_TRANSAC_DTK_ENTITY_X <- xml_text( xml_find_all( doc, V_BIZ_TRANSAC_DTK_ENTITY_X ) )
...
F9_04_CONTR_NONCSH_MT_25K_X <- xml_text( xml_find_all( doc, V_CONTR_NONCSH_MT_25K_X ) )
...
F9_04_CONTR_ART_HIST_X <- xml_text( xml_find_all( doc, V_CONTR_ART_HIST_X ) )
...
F9_04_LTD_X <- xml_text( xml_find_all( doc, V_LTD_X ) )
...
F9_04_LTD_DOA_X <- xml_text( xml_find_all( doc, V_LTD_DOA_X ) )
...
F9_04_DOA_X <- xml_text( xml_find_all( doc, V_DOA_X ) )
...
F9_04_ENTITY_DISREG_X <- xml_text( xml_find_all( doc, V_ENTITY_DISREG_X ) )
...
F9_04_ENTITY_RLTD_X <- xml_text( xml_find_all( doc, V_ENTITY_RLTD_X ) )
...
F9_04_ENTITY_CTRL_X <- xml_text( xml_find_all( doc, V_ENTITY_CTRL_X ) )
...
F9_04_ENTITY_CTRL_TRANSAC_X <- xml_text( xml_find_all( doc, V_ENTITY_CTRL_TRANSAC_X ) )
...
F9_04_TRANSFER_EXEMPT_ORG_X <- xml_text( xml_find_all( doc, V_TRANSFER_EXEMPT_ORG_X ) )
...
F9_04_PTR_ACT_X <- xml_text( xml_find_all( doc, V_PTR_ACT_X ) )
