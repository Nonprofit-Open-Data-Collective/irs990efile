...
SN_99_ORG_DETERMIN_LETTER_X <- xml_text( xml_find_all( doc, V_ORG_DETERMIN_LETTER_X ) )
...
SN_99_ORG_DATE_LETTER <- xml_text( xml_find_all( doc, V_ORG_DATE_LETTER ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SN_99_ORG_DETERMIN_LETTER_X,SN_99_ORG_DATE_LETTER)
