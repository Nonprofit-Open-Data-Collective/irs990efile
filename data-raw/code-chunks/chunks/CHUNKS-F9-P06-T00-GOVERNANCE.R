...
F9_06_INFO_SCHED_O_X <- xml_text( xml_find_all( doc, V_INFO_SCHED_O_X ) )
...
F9_06_GVRN_NUM_VOTING_MEMB <- xml_text( xml_find_all( doc, V_GVRN_NUM_VOTING_MEMB ) )
...
F9_06_GVRN_NUM_VOTING_MEMB_IND <- xml_text( xml_find_all( doc, V_GVRN_NUM_VOTING_MEMB_IND ) )
...
F9_06_GVRN_DTK_FAMBIZ_RELATION_X <- xml_text( xml_find_all( doc, V_GVRN_DTK_FAMBIZ_RELATION_X ) )
...
F9_06_GVRN_DELEGATE_MGMT_DUTY_X <- xml_text( xml_find_all( doc, V_GVRN_DELEGATE_MGMT_DUTY_X ) )
...
F9_06_GVRN_CHANGE_DOC_X <- xml_text( xml_find_all( doc, V_GVRN_CHANGE_DOC_X ) )
...
F9_06_GVRN_ASSET_DIVERSION_X <- xml_text( xml_find_all( doc, V_GVRN_ASSET_DIVERSION_X ) )
...
F9_06_GVRN_MEMB_STCKHLDR_X <- xml_text( xml_find_all( doc, V_GVRN_MEMB_STCKHLDR_X ) )
...
F9_06_GVRN_PERS_ELECT_MEMB_X <- xml_text( xml_find_all( doc, V_GVRN_PERS_ELECT_MEMB_X ) )
...
F9_06_GVRN_DECISION_APPROV_X <- xml_text( xml_find_all( doc, V_GVRN_DECISION_APPROV_X ) )
...
F9_06_GVRN_DOC_GVRN_BODY_X <- xml_text( xml_find_all( doc, V_GVRN_DOC_GVRN_BODY_X ) )
...
F9_06_GVRN_DOC_COMMITTEE_X <- xml_text( xml_find_all( doc, V_GVRN_DOC_COMMITTEE_X ) )
...
F9_06_GVRN_DTK_NO_MAILING_ADDR_X <- xml_text( xml_find_all( doc, V_GVRN_DTK_NO_MAILING_ADDR_X ) )
...
F9_06_POLICY_CHPTR_AFFIL_X <- xml_text( xml_find_all( doc, V_POLICY_CHPTR_AFFIL_X ) )
...
F9_06_POLICY_CHPTR_REFERENCE_X <- xml_text( xml_find_all( doc, V_POLICY_CHPTR_REFERENCE_X ) )
...
F9_06_POLICY_FORM990_GVRN_BODY_X <- xml_text( xml_find_all( doc, V_POLICY_FORM990_GVRN_BODY_X ) )
...
F9_06_POLICY_COI_X <- xml_text( xml_find_all( doc, V_POLICY_COI_X ) )
...
F9_06_POLICY_COI_DISCLOSURE_X <- xml_text( xml_find_all( doc, V_POLICY_COI_DISCLOSURE_X ) )
...
F9_06_POLICY_COI_MONITOR_X <- xml_text( xml_find_all( doc, V_POLICY_COI_MONITOR_X ) )
...
F9_06_POLICY_WHSTLBLWR_X <- xml_text( xml_find_all( doc, V_POLICY_WHSTLBLWR_X ) )
...
F9_06_POLICY_DOC_RETENTION_X <- xml_text( xml_find_all( doc, V_POLICY_DOC_RETENTION_X ) )
...
F9_06_POLICY_COMP_PROCESS_CEO_X <- xml_text( xml_find_all( doc, V_POLICY_COMP_PROCESS_CEO_X ) )
...
F9_06_POLICY_COMP_PROCESS_OTH_X <- xml_text( xml_find_all( doc, V_POLICY_COMP_PROCESS_OTH_X ) )
...
F9_06_POLICY_JV_X <- xml_text( xml_find_all( doc, V_POLICY_JV_X ) )
...
F9_06_POLICY_JV_PROC_X <- xml_text( xml_find_all( doc, V_POLICY_JV_PROC_X ) )
...
F9_06_DISCLOSURE_STATES_FILED <- xml_text( xml_find_all( doc, V_DISCLOSURE_STATES_FILED ) )
...
F9_06_DISCLOSURE_AVBL_OTH_WEB_X <- xml_text( xml_find_all( doc, V_DISCLOSURE_AVBL_OTH_WEB_X ) )
...
F9_06_DISCLOSURE_AVBL_OTH_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990/OtherInd' ) )
...
F9_06_DISCLOSURE_AVBL_OWN_WEB_X <- xml_text( xml_find_all( doc, V_DISCLOSURE_AVBL_OWN_WEB_X ) )
...
F9_06_DISCLOSURE_AVBL_REQUEST_X <- xml_text( xml_find_all( doc, V_DISCLOSURE_AVBL_REQUEST_X ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_CITY <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_CITY ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_CNTR <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_CNTR ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_L1 <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_L1 ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_L2 <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_L2 ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_STATE <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_STATE ) )
...
F9_06_DISCLOSURE_BOOK_ADDR_ZIP <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_ADDR_ZIP ) )
...
F9_06_DISCLOSURE_BOOK_NAME_L1 <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_NAME_L1 ) )
...
F9_06_DISCLOSURE_BOOK_NAME_L2 <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_NAME_L2 ) )
...
F9_06_DISCLOSURE_BOOK_NAME_PERS <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_NAME_PERS ) )
...
F9_06_DISCLOSURE_BOOK_PHONE <- xml_text( xml_find_all( doc, V_DISCLOSURE_BOOK_PHONE ) )
