...
SE_01_POLICY_STMT_NONDISCR_X <- xml_text( xml_find_all( doc, V_POLICY_STMT_NONDISCR_X ) )
...
SE_01_POLICY_STMT_BROCHURES_X <- xml_text( xml_find_all( doc, V_POLICY_STMT_BROCHURES_X ) )
...
SE_01_POLICY_BCAST_MEDIA_X <- xml_text( xml_find_all( doc, V_POLICY_BCAST_MEDIA_X ) )
...
SE_01_POLICY_BCAST_MEDIA_EXPLAIN <- xml_text( xml_find_all( doc, V_POLICY_BCAST_MEDIA_EXPLAIN ) )
...
SE_01_MAINT_RACIAL_RECORD_X <- xml_text( xml_find_all( doc, V_MAINT_RACIAL_RECORD_X ) )
...
SE_01_MAINT_SCHOLARSHIP_RECORD_X <- xml_text( xml_find_all( doc, V_MAINT_SCHOLARSHIP_RECORD_X ) )
...
SE_01_MAINT_COPY_BROCHURES_X <- xml_text( xml_find_all( doc, V_MAINT_COPY_BROCHURES_X ) )
...
SE_01_MAINT_COPY_SOL_X <- xml_text( xml_find_all( doc, V_MAINT_COPY_SOL_X ) )
...
SE_01_MAINT_EXPLANATION <- xml_text( xml_find_all( doc, V_MAINT_EXPLANATION ) )
...
SE_01_DISCR_RACE_STUDENT_RIGHT_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_STUDENT_RIGHT_X ) )
...
SE_01_DISCR_RACE_ADM_POLICY_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_ADM_POLICY_X ) )
...
SE_01_DISCR_RACE_EMPL_FACULTY_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_EMPL_FACULTY_X ) )
...
SE_01_DISCR_RACE_SCHOLARSHIP_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_SCHOLARSHIP_X ) )
...
SE_01_DISCR_RACE_EDU_POLICY_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_EDU_POLICY_X ) )
...
SE_01_DISCR_RACE_USE_FACILITY_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_USE_FACILITY_X ) )
...
SE_01_DISCR_RACE_ATHLETIC_PROG_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_ATHLETIC_PROG_X ) )
...
SE_01_DISCR_RACE_OTH_ACT_X <- xml_text( xml_find_all( doc, V_DISCR_RACE_OTH_ACT_X ) )
...
SE_01_DISCR_RACE_EXPLANATION <- xml_text( xml_find_all( doc, V_DISCR_RACE_EXPLANATION ) )
...
SE_01_GOVT_FIN_AID_REC_X <- xml_text( xml_find_all( doc, V_GOVT_FIN_AID_REC_X ) )
...
SE_01_GOVT_FIN_AID_REVOKED_X <- xml_text( xml_find_all( doc, V_GOVT_FIN_AID_REVOKED_X ) )
...
SE_01_GOVT_FIN_AID_EXPLANATION <- xml_text( xml_find_all( doc, V_GOVT_FIN_AID_EXPLANATION ) )
...
SE_01_COMPLIANCE_REV_PROC_7550_X <- xml_text( xml_find_all( doc, V_COMPLIANCE_REV_PROC_7550_X ) )
