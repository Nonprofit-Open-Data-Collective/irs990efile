...
SD_99_RECO_NETASSET_REV_TOT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleD/TotalRevenue' ) )
...
SD_99_RECO_NETASSET_EXP_TOT <- xml_text( xml_find_all( doc, V_RECO_NETASSET_EXP_TOT ) )
...
SD_99_RECO_NETASSET_EXCESS <- xml_text( xml_find_all( doc, V_RECO_NETASSET_EXCESS ) )
...
SD_99_RECO_NETASSET_NUGAINS <- xml_text( xml_find_all( doc, V_RECO_NETASSET_NUGAINS ) )
...
SD_99_RECO_NETASSET_DONATED_SVC <- xml_text( xml_find_all( doc, V_RECO_NETASSET_DONATED_SVC ) )
...
SD_99_RECO_NETASSET_INVEST_EXP <- xml_text( xml_find_all( doc, V_RECO_NETASSET_INVEST_EXP ) )
...
SD_99_RECO_NETASSET_PRIOR_ADJ <- xml_text( xml_find_all( doc, V_RECO_NETASSET_PRIOR_ADJ ) )
...
SD_99_RECO_NETASSET_OTH <- xml_text( xml_find_all( doc, V_RECO_NETASSET_OTH ) )
...
SD_99_RECO_NETASSET_TOT_ADJ <- xml_text( xml_find_all( doc, V_RECO_NETASSET_TOT_ADJ ) )
...
SD_99_RECO_NETASSET_EXCESS_AFS <- xml_text( xml_find_all( doc, V_RECO_NETASSET_EXCESS_AFS ) )
