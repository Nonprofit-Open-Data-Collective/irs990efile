...
SI_99_GRANT_US_ORG_LT_5K_X <- xml_text( xml_find_all( doc, V_GRANT_US_ORG_LT_5K_X ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SI_99_GRANT_US_ORG_LT_5K_X)
