...
SH_99_CHNA_AVBL_REQUEST_X <- xml_text( xml_find_all( doc, V_CHNA_AVBL_REQUEST_X ) )
...
SH_99_CHNA_NEED_ADOPT_IMP_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_ADOPT_IMP_X ) )
...
SH_99_CHNA_NEED_EXECUTE_IMP_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_EXECUTE_IMP_X ) )
...
SH_99_CHNA_NEED_DEVELOP_PLAN_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_DEVELOP_PLAN_X ) )
...
SH_99_CHNA_NEED_PARTICIPA_PLAN_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_PARTICIPA_PLAN_X ) )
...
SH_99_CHNA_NEED_INCL_PLAN_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_INCL_PLAN_X ) )
...
SH_99_CHNA_NEED_ADOPT_BUDGET_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_ADOPT_BUDGET_X ) )
...
SH_99_CHNA_NEED_PRIORITIZA_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_PRIORITIZA_X ) )
...
SH_99_CHNA_NEED_PRIORITIZA_SVC_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_PRIORITIZA_SVC_X ) )
...
SH_99_CHNA_NEED_OTH_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_OTH_X ) )
...
SH_99_CHNA_NEED_ALL_ADDRESSED_X <- xml_text( xml_find_all( doc, V_CHNA_NEED_ALL_ADDRESSED_X ) )
...
SH_99_FAP_USE_FPG_FREE_CARE_PCT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/Form990ScheduleHPartVSectionB/FPGFreePercent' ) )
...
SH_99_FAP_USE_FPG_FREE_CARE_X <- xml_text( xml_find_all( doc, V_FAP_USE_FPG_FREE_CARE_X ) )
...
SH_99_FAP_USE_FPG_DCNT_CARE_PCT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/Form990ScheduleHPartVSectionB/FPGDiscountPercent' ) )
...
SH_99_FAP_USE_FPG_DCNT_CARE_X <- xml_text( xml_find_all( doc, V_FAP_USE_FPG_DCNT_CARE_X ) )
...
SH_99_FAP_FACTOR_INCOME_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_INCOME_X ) )
...
SH_99_FAP_FACTOR_ASSET_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_ASSET_X ) )
...
SH_99_FAP_FACTOR_INDIGENCY_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_INDIGENCY_X ) )
...
SH_99_FAP_FACTOR_INSURANCE_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_INSURANCE_X ) )
...
SH_99_FAP_FACTOR_UNINSURED_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_UNINSURED_X ) )
...
SH_99_FAP_FACTOR_MEDICAID_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_MEDICAID_X ) )
...
SH_99_FAP_FACTOR_STATE_REG_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_STATE_REG_X ) )
...
SH_99_FAP_FACTOR_RESIDENCY_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/HospitalFcltyPoliciesPrctcGrp/ResidencyInd' ) )
...
SH_99_FAP_FACTOR_OTH_X <- xml_text( xml_find_all( doc, V_FAP_FACTOR_OTH_X ) )
...
SH_99_FAP_PROV_PUBLICITY_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/Form990ScheduleHPartVSectionB/IncludesPublicityMeasures' ) )
...
SH_99_FAP_PROV_WEBSITE_X <- xml_text( xml_find_all( doc, V_FAP_PROV_WEBSITE_X ) )
...
SH_99_FAP_PROV_ATTACH_INVOICE_X <- xml_text( xml_find_all( doc, V_FAP_PROV_ATTACH_INVOICE_X ) )
...
SH_99_FAP_PROV_EMERGENCY_ROOM_X <- xml_text( xml_find_all( doc, V_FAP_PROV_EMERGENCY_ROOM_X ) )
...
SH_99_FAP_PROV_ADM_OFFICE_X <- xml_text( xml_find_all( doc, V_FAP_PROV_ADM_OFFICE_X ) )
...
SH_99_FAP_PROV_ADM_X <- xml_text( xml_find_all( doc, V_FAP_PROV_ADM_X ) )
...
SH_99_FAP_PROV_REQUEST_X <- xml_text( xml_find_all( doc, V_FAP_PROV_REQUEST_X ) )
...
SH_99_FAP_PROV_OTH_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/Form990ScheduleHPartVSectionB/OtherPublicity' ) )
...
SH_99_BILL_PERMIT_LAWSUIT_X <- xml_text( xml_find_all( doc, V_BILL_PERMIT_LAWSUIT_X ) )
...
SH_99_BILL_PERMIT_LIEN_X <- xml_text( xml_find_all( doc, V_BILL_PERMIT_LIEN_X ) )
...
SH_99_BILL_PERMIT_BODY_ATTACH_X <- xml_text( xml_find_all( doc, V_BILL_PERMIT_BODY_ATTACH_X ) )
...
SH_99_FAP_AVBL_NOTICE_DISPLAY_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/HospitalFcltyPoliciesPrctcGrp/FAPNoticeDisplayedInd' ) )
...
SH_99_BILL_3RD_PARTY_LAWSUIT_X <- xml_text( xml_find_all( doc, V_BILL_3RD_PARTY_LAWSUIT_X ) )
...
SH_99_BILL_3RD_PARTY_LIEN_X <- xml_text( xml_find_all( doc, V_BILL_3RD_PARTY_LIEN_X ) )
...
SH_99_BILL_3RD_PARTY_BODY_X <- xml_text( xml_find_all( doc, V_BILL_3RD_PARTY_BODY_X ) )
...
SH_99_BILL_NOTIFIED_ADM_X <- xml_text( xml_find_all( doc, V_BILL_NOTIFIED_ADM_X ) )
...
SH_99_BILL_NOTIFIED_DISCHARGE_X <- xml_text( xml_find_all( doc, V_BILL_NOTIFIED_DISCHARGE_X ) )
...
SH_99_BILL_NOTIFIED_PATIENT_X <- xml_text( xml_find_all( doc, V_BILL_NOTIFIED_PATIENT_X ) )
...
SH_99_BILL_NOTIFIED_DOC_X <- xml_text( xml_find_all( doc, V_BILL_NOTIFIED_DOC_X ) )
...
SH_99_BILL_NOTIFIED_OTH_ACT_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990ScheduleH/Form990ScheduleHPartVSectionB/OtherActionsTaken' ) )
...
SH_99_CHARGE_LOW_RATE_X <- xml_text( xml_find_all( doc, V_CHARGE_LOW_RATE_X ) )
...
SH_99_CHARGE_AVE_RATE_X <- xml_text( xml_find_all( doc, V_CHARGE_AVE_RATE_X ) )
...
SH_99_CHARGE_MT_MEDICARE_RATE_X <- xml_text( xml_find_all( doc, V_CHARGE_MT_MEDICARE_RATE_X ) )
