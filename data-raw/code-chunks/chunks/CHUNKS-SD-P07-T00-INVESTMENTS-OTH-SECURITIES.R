#' @title 
#'   Build table SD-P07-T00-INVESTMENTS-OTH-SECURITIES
#' 
#' @description 
#'   Generate a 1:1 table for the relational database.
#' 
#' @export 
BUILD_SD_P07_T00_INVESTMENTS_OTH_SECURITIES <- function( doc, url )
{
...
## TABLE:  SD-P07-T00-INVESTMENTS-OTH-SECURITIES
## VARIABLE TYPE:  numeric
## PRODUCTION RULE:  
...
SD_07_INVEST_SEC_TOT_BV <- xml_text( xml_find_all( doc, V_INVEST_SEC_TOT_BV ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SD_07_INVEST_SEC_TOT_BV)
