...
SL_02_LOAN_BALANCE_DUE_TOT <- xml_text( xml_find_all( doc, V_LOAN_BALANCE_DUE_TOT ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SL_02_LOAN_BALANCE_DUE_TOT)
