...
F9_04_LOAN_DTK_AMT <- xml_text( xml_find_all( doc, V_LOAN_DTK_AMT ) )
...
F9_04_FRGN_OFFICE_CNTR <- xml_text( xml_find_all( doc, V_FRGN_OFFICE_CNTR ) )
...
F9_04_RLTD_ORG_527_X <- xml_text( xml_find_all( doc, V_RLTD_ORG_527_X ) )
