...
SF_02_FRGN_ORG_GRANT_501C3_TOT <- xml_text( xml_find_all( doc, V_FRGN_ORG_GRANT_501C3_TOT ) )
...
SF_02_FRGN_ORG_GRANT_OTH_ORG_TOT <- xml_text( xml_find_all( doc, V_FRGN_ORG_GRANT_OTH_ORG_TOT ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SF_02_FRGN_ORG_GRANT_501C3_TOT,SF_02_FRGN_ORG_GRANT_OTH_ORG_TOT)
