...
F9_07_COMP_KONTR_NUM_GT_100K <- xml_text( xml_find_all( doc, V_COMP_KONTR_NUM_GT_100K ) )
...
F9_07_COMP_DTK_COMP_OTH_SOURCE_X <- xml_text( xml_find_all( doc, V_COMP_DTK_COMP_OTH_SOURCE_X ) )
...
F9_07_COMP_DTK_FORMER_LISTED_X <- xml_text( xml_find_all( doc, V_COMP_DTK_FORMER_LISTED_X ) )
...
F9_07_COMP_DTK_COMP_GT_150K_X <- xml_text( xml_find_all( doc, V_COMP_DTK_COMP_GT_150K_X ) )
...
F9_07_COMP_DTK_NO_LISTED_X <- xml_text( xml_find_all( doc, V_COMP_DTK_NO_LISTED_X ) )
...
F9_07_COMP_DTK_NUM_GT_100K <- xml_text( xml_find_all( doc, V_COMP_DTK_NUM_GT_100K ) )
...
F9_07_COMP_DTK_COMP_ORG_SUBTOT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990/Form990PartVIISectionA/TotalColumnD' ) )
...
F9_07_COMP_DTK_COMP_RLTD_SUBTOT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990/Form990PartVIISectionA/TotalColumnE' ) )
...
F9_07_COMP_DTK_COMP_OTH_SUBTOT <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990/Form990PartVIISectionA/TotalColumnF' ) )
...
F9_07_INFO_SCHED_O_X <- xml_text( xml_find_all( doc, V_INFO_SCHED_O_X ) )
...
F9_07_COMP_DTK_COMP_OTH_TOT <- xml_text( xml_find_all( doc, V_COMP_DTK_COMP_OTH_TOT ) )
...
F9_07_COMP_DTK_COMP_RLTD_TOT <- xml_text( xml_find_all( doc, V_COMP_DTK_COMP_RLTD_TOT ) )
...
F9_07_COMP_DTK_COMP_ORG_TOT <- xml_text( xml_find_all( doc, V_COMP_DTK_COMP_ORG_TOT ) )
...
F9_07_SCHED_A_FILED_X <- xml_text( xml_find_all( doc, V_SCHED_A_FILED_X ) )
