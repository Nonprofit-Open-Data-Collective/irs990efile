...
SR_05_TRANSAC_RCPT_INT_X <- xml_text( xml_find_all( doc, V_TRANSAC_RCPT_INT_X ) )
...
SR_05_TRANSAC_GIFT_GRANT_TO_X <- xml_text( xml_find_all( doc, V_TRANSAC_GIFT_GRANT_TO_X ) )
...
SR_05_TRANSAC_GIFT_GRANT_FROM_X <- xml_text( xml_find_all( doc, V_TRANSAC_GIFT_GRANT_FROM_X ) )
...
SR_05_TRANSAC_LOAN_TO_X <- xml_text( xml_find_all( doc, V_TRANSAC_LOAN_TO_X ) )
...
SR_05_TRANSAC_LOAN_BY_X <- xml_text( xml_find_all( doc, V_TRANSAC_LOAN_BY_X ) )
...
SR_05_TRANSAC_DIVIDEND_X <- xml_text( xml_find_all( doc, V_TRANSAC_DIVIDEND_X ) )
...
SR_05_TRANSAC_SALE_ASSET_X <- xml_text( xml_find_all( doc, V_TRANSAC_SALE_ASSET_X ) )
...
SR_05_TRANSAC_PURCHASE_ASSET_X <- xml_text( xml_find_all( doc, V_TRANSAC_PURCHASE_ASSET_X ) )
...
SR_05_TRANSAC_EXCHANGE_ASSET_X <- xml_text( xml_find_all( doc, V_TRANSAC_EXCHANGE_ASSET_X ) )
...
SR_05_TRANSAC_LEASE_TO_X <- xml_text( xml_find_all( doc, V_TRANSAC_LEASE_TO_X ) )
...
SR_05_TRANSAC_LEASE_FROM_X <- xml_text( xml_find_all( doc, V_TRANSAC_LEASE_FROM_X ) )
...
SR_05_TRANSAC_PERFORM_SVC_FOR_X <- xml_text( xml_find_all( doc, V_TRANSAC_PERFORM_SVC_FOR_X ) )
...
SR_05_TRANSAC_PERFORM_SVC_BY_X <- xml_text( xml_find_all( doc, V_TRANSAC_PERFORM_SVC_BY_X ) )
...
SR_05_TRANSAC_SHARE_FACILITIES_X <- xml_text( xml_find_all( doc, V_TRANSAC_SHARE_FACILITIES_X ) )
...
SR_05_TRANSAC_SHARE_PAID_EMPL_X <- xml_text( xml_find_all( doc, V_TRANSAC_SHARE_PAID_EMPL_X ) )
...
SR_05_TRANSAC_REIMBURSEMENT_TO_X <- xml_text( xml_find_all( doc, V_TRANSAC_REIMBURSEMENT_TO_X ) )
...
SR_05_TRANSAC_REIMBURSEMENT_BY_X <- xml_text( xml_find_all( doc, V_TRANSAC_REIMBURSEMENT_BY_X ) )
...
SR_05_TRANSAC_OTH_CASH_TO_X <- xml_text( xml_find_all( doc, V_TRANSAC_OTH_CASH_TO_X ) )
