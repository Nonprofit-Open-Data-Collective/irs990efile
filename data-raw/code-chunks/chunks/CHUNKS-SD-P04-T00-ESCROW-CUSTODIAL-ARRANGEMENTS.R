...
SD_04_AGENT_TRUSTEE_OTH_X <- xml_text( xml_find_all( doc, V_AGENT_TRUSTEE_OTH_X ) )
...
SD_04_ESCROW_BALANCE_BEG <- xml_text( xml_find_all( doc, V_ESCROW_BALANCE_BEG ) )
...
SD_04_ESCROW_ADDITION <- xml_text( xml_find_all( doc, V_ESCROW_ADDITION ) )
...
SD_04_ESCROW_DIST <- xml_text( xml_find_all( doc, V_ESCROW_DIST ) )
...
SD_04_ESCROW_BALANCE_END <- xml_text( xml_find_all( doc, V_ESCROW_BALANCE_END ) )
...
SD_04_ESCROW_ACC_LIAB_INCL_P10_X <- xml_text( xml_find_all( doc, V_ESCROW_ACC_LIAB_INCL_P10_X ) )
...
SD_04_EXPLANATION_P13_X <- xml_text( xml_find_all( doc, V_EXPLANATION_P13_X ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SD_04_AGENT_TRUSTEE_OTH_X,SD_04_ESCROW_BALANCE_BEG,SD_04_ESCROW_ADDITION,SD_04_ESCROW_DIST,SD_04_ESCROW_BALANCE_END,SD_04_ESCROW_ACC_LIAB_INCL_P10_X,SD_04_EXPLANATION_P13_X)
