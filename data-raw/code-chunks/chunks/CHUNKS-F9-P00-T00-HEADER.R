...
F9_00_NAME_ORG_CTRL <- xml_text( xml_find_all( doc, V_NAME_ORG_CTRL ) )
...
F9_00_BUILD_TIME_STAMP <- xml_text( xml_find_all( doc, '/Return/ReturnHeader/BuildTS' ) )
...
F9_00_RETURN_TIME_STAMP <- xml_text( xml_find_all( doc, V_RETURN_TIME_STAMP ) )
...
F9_00_SPECIAL_COND_DESC <- xml_text( xml_find_all( doc, V_SPECIAL_COND_DESC ) )
...
F9_00_TAX_PERIOD_BEGIN_DATE <- xml_text( xml_find_all( doc, V_TAX_PERIOD_BEGIN_DATE ) )
...
F9_00_TAX_PERIOD_END_DATE <- xml_text( xml_find_all( doc, V_TAX_PERIOD_END_DATE ) )
...
F9_00_FORM_ADDR_CHANGE_X <- xml_text( xml_find_all( doc, V_FORM_ADDR_CHANGE_X ) )
...
F9_00_FORM_AMENDED_RETURN_X <- xml_text( xml_find_all( doc, V_FORM_AMENDED_RETURN_X ) )
...
F9_00_FORM_FINAL_RETURN_X <- xml_text( xml_find_all( doc, V_FORM_FINAL_RETURN_X ) )
...
F9_00_FORM_INITIAL_RETURN_X <- xml_text( xml_find_all( doc, V_FORM_INITIAL_RETURN_X ) )
...
F9_00_ORG_ADDR_CITY <- xml_text( xml_find_all( doc, V_ORG_ADDR_CITY ) )
...
F9_00_ORG_ADDR_CNTR <- xml_text( xml_find_all( doc, V_ORG_ADDR_CNTR ) )
...
F9_00_ORG_ADDR_IN_CARE_OF <- xml_text( xml_find_all( doc, '/Return/ReturnHeader/Filer/InCareOfNm' ) )
...
F9_00_ORG_ADDR_L1 <- xml_text( xml_find_all( doc, V_ORG_ADDR_L1 ) )
...
F9_00_ORG_ADDR_L2 <- xml_text( xml_find_all( doc, V_ORG_ADDR_L2 ) )
...
F9_00_ORG_ADDR_STATE <- xml_text( xml_find_all( doc, V_ORG_ADDR_STATE ) )
...
F9_00_ORG_ADDR_ZIP <- xml_text( xml_find_all( doc, V_ORG_ADDR_ZIP ) )
...
F9_00_ORG_NAME_DBA_L1 <- xml_text( xml_find_all( doc, V_ORG_NAME_DBA_L1 ) )
...
F9_00_ORG_NAME_DBA_L2 <- xml_text( xml_find_all( doc, V_ORG_NAME_DBA_L2 ) )
...
F9_00_ORG_PHONE <- xml_text( xml_find_all( doc, V_ORG_PHONE ) )
...
F9_00_PRIN_OFF_ADDR_CITY <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_CITY ) )
...
F9_00_PRIN_OFF_ADDR_CNTR <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_CNTR ) )
...
F9_00_PRIN_OFF_ADDR_L1 <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_L1 ) )
...
F9_00_PRIN_OFF_ADDR_L2 <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_L2 ) )
...
F9_00_PRIN_OFF_ADDR_STATE <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_STATE ) )
...
F9_00_PRIN_OFF_ADDR_ZIP <- xml_text( xml_find_all( doc, V_PRIN_OFF_ADDR_ZIP ) )
...
F9_00_PRIN_OFF_NAME_ORG_L1 <- xml_text( xml_find_all( doc, V_PRIN_OFF_NAME_ORG_L1 ) )
...
F9_00_PRIN_OFF_NAME_ORG_L2 <- xml_text( xml_find_all( doc, V_PRIN_OFF_NAME_ORG_L2 ) )
...
F9_00_PRIN_OFF_NAME_PERS <- xml_text( xml_find_all( doc, V_PRIN_OFF_NAME_PERS ) )
...
F9_00_GRO_RCPT <- xml_text( xml_find_all( doc, V_GRO_RCPT ) )
...
F9_00_GROUP_RETURN_AFFIL_X <- xml_text( xml_find_all( doc, V_GROUP_RETURN_AFFIL_X ) )
...
F9_00_ALL_AFFIL_INCL_X <- xml_text( xml_find_all( doc, V_ALL_AFFIL_INCL_X ) )
...
F9_00_GROUP_EXEMPT_NUM <- xml_text( xml_find_all( doc, V_GROUP_EXEMPT_NUM ) )
...
F9_00_EXEMPT_STAT_4947A1_X <- xml_text( xml_find_all( doc, V_EXEMPT_STAT_4947A1_X ) )
...
F9_00_EXEMPT_STAT_501C_X <- xml_text( xml_find_all( doc, V_EXEMPT_STAT_501C_X ) )
...
F9_00_EXEMPT_STAT_501C3_X <- xml_text( xml_find_all( doc, V_EXEMPT_STAT_501C3_X ) )
...
F9_00_EXEMPT_STAT_527_X <- xml_text( xml_find_all( doc, '/Return/ReturnData/IRS990/Form990PartI/Organization527' ) )
...
F9_00_ORG_WEBSITE <- xml_text( xml_find_all( doc, V_ORG_WEBSITE ) )
...
F9_00_TYPE_ORG_ASSOC_X <- xml_text( xml_find_all( doc, V_TYPE_ORG_ASSOC_X ) )
...
F9_00_TYPE_ORG_CORP_X <- xml_text( xml_find_all( doc, V_TYPE_ORG_CORP_X ) )
...
F9_00_TYPE_ORG_OTH_DESC <- xml_text( xml_find_all( doc, V_TYPE_ORG_OTH_DESC ) )
...
F9_00_TYPE_ORG_OTH_X <- xml_text( xml_find_all( doc, V_TYPE_ORG_OTH_X ) )
...
F9_00_TYPE_ORG_TRUST_X <- xml_text( xml_find_all( doc, V_TYPE_ORG_TRUST_X ) )
...
F9_00_YEAR_FORMATION <- xml_text( xml_find_all( doc, V_YEAR_FORMATION ) )
...
F9_00_LEGAL_DMCL_CNTR <- xml_text( xml_find_all( doc, V_LEGAL_DMCL_CNTR ) )
...
F9_00_LEGAL_DMCL_STATE <- xml_text( xml_find_all( doc, V_LEGAL_DMCL_STATE ) )
