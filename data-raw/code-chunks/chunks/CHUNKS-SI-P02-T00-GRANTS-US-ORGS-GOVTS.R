...
SI_02_GRANT_US_ORG_501C3_TOT <- xml_text( xml_find_all( doc, V_GRANT_US_ORG_501C3_TOT ) )
...
SI_02_GRANT_US_ORG_OTH_TOT <- xml_text( xml_find_all( doc, V_GRANT_US_ORG_OTH_TOT ) )
