...
SD_01_TOT_NUM_EOY_DAF <- xml_text( xml_find_all( doc, V_TOT_NUM_EOY_DAF ) )
...
SD_01_TOT_NUM_EOY_OTH <- xml_text( xml_find_all( doc, V_TOT_NUM_EOY_OTH ) )
...
SD_01_AGGREGATE_CONTR_DAF <- xml_text( xml_find_all( doc, V_AGGREGATE_CONTR_DAF ) )
...
SD_01_AGGREGATE_CONTR_OTH <- xml_text( xml_find_all( doc, V_AGGREGATE_CONTR_OTH ) )
...
SD_01_AGGREGATE_GRANT_DAF <- xml_text( xml_find_all( doc, V_AGGREGATE_GRANT_DAF ) )
...
SD_01_AGGREGATE_GRANT_OTH <- xml_text( xml_find_all( doc, V_AGGREGATE_GRANT_OTH ) )
...
SD_01_AGGREGATE_VALUE_EOY_DAF <- xml_text( xml_find_all( doc, V_AGGREGATE_VALUE_EOY_DAF ) )
...
SD_01_AGGREGATE_VALUE_EOY_OTH <- xml_text( xml_find_all( doc, V_AGGREGATE_VALUE_EOY_OTH ) )
...
SD_01_DISCLOSE_LEGAL_CTRL_DAF_X <- xml_text( xml_find_all( doc, V_DISCLOSE_LEGAL_CTRL_DAF_X ) )
...
SD_01_DISCLOSE_CHARIT_PURPOSE_X <- xml_text( xml_find_all( doc, V_DISCLOSE_CHARIT_PURPOSE_X ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SD_01_TOT_NUM_EOY_DAF,SD_01_TOT_NUM_EOY_OTH,SD_01_AGGREGATE_CONTR_DAF,SD_01_AGGREGATE_CONTR_OTH,SD_01_AGGREGATE_GRANT_DAF,SD_01_AGGREGATE_GRANT_OTH,SD_01_AGGREGATE_VALUE_EOY_DAF,SD_01_AGGREGATE_VALUE_EOY_OTH,SD_01_DISCLOSE_LEGAL_CTRL_DAF_X,SD_01_DISCLOSE_CHARIT_PURPOSE_X)
