...
SN_02_ORG_DTK_DIR_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_DIR_SUCCESSOR_X ) )
...
SN_02_ORG_DTK_EMPL_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_EMPL_SUCCESSOR_X ) )
...
SN_02_ORG_DTK_OWN_SUCCESSOR_X <- xml_text( xml_find_all( doc, V_ORG_DTK_OWN_SUCCESSOR_X ) )
...
SN_02_ORG_DTK_REC_COMP_X <- xml_text( xml_find_all( doc, V_ORG_DTK_REC_COMP_X ) )




var.list <- 
namedList(OBJECTID,URL,ORG_EIN,ORG_NAME_L1,ORG_NAME_L2,RETURN_TYPE,TAX_YEAR,SN_02_ORG_DTK_DIR_SUCCESSOR_X,SN_02_ORG_DTK_EMPL_SUCCESSOR_X,SN_02_ORG_DTK_OWN_SUCCESSOR_X,SN_02_ORG_DTK_REC_COMP_X)
